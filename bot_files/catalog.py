...
# ==========================================
# السيرفرات الثلاثة المعتمدة (5SIM + Grizzly + Hero)
# ==========================================
...
# ==========================================
# عروض أرقام تيليجرام الجاهزة (TG Ready)
# ==========================================
TG_READY_ACCOUNTS = {
    "tg_acc_usa": {
        "id": "tg_acc_usa",
        ...
        "price_usd": 1.20,
        "price_rub": 36.0,
        "type": "جلسة Tdata / Session جاهزة",
        "desc": "حساب تيليجرام أمريكي موثق وجاهز للاستخدام الفوري."
    },
    "tg_acc_ru": {
        "id": "tg_acc_ru",
        "country": "روسيا 🇷🇺",
        "price_usd": 0.90,
        "price_rub": 27.0,
        "type": "حساب تيليجرام روسي عالي الثبات",
        "desc": "جاهز مع كود الدخول / Session ملف فوري."
    },
    "tg_acc_id": {
        "id": "tg_acc_id",
        "country": "إندونيسيا 🇮🇩",
        "price_usd": 0.75,
        "price_rub": 22.5,
        "type": "حساب تليجرام إندونيسي اقتصادي",
        "desc": "مناسب للرشق والتسويق واستخدام القنوات."
    },
    "tg_acc_uk": {
        "id": "tg_acc_uk",
        ...
        "price_usd": 1.50,
        "price_rub": 45.0,
        "type": "حساب بريطاني مميز (+44)",
        "desc": "رقم بريطاني حقيقي مسجل وجاهز للتسليم الآلي."
    }
}
