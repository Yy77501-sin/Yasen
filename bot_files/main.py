...
def router_callback(call):
    try:
        ...
        # ----------------- لوحة تحكم الإدارة -----------------
            ...
            try:
                bot.answer_callback_query(call.id, "🔑 جاري فتح إدارة المزودين ومفاتيح API...")
            except Exception:
                pass
            if not is_admin_user(user_id):
                try:
            ...
            try:
                ...
                gz_display = (gz_k[:10] + "...") if len(gz_k) > 10 else (gz_k if gz_k else "غير مدخل")

                text = (
                    "🔑 **لوحة إدارة المزودين ومفاتيح الـ API:**\n"
                    "━━━━━━━━━━━━━━━━━━\n"
                    ...
                    "━━━━━━━━━━━━━━━━━━\n"
                    "👇 اضغط على أي مزود لفحص رصيده أو تعديل المفتاح الخاص به:"
                )
                markup = types.InlineKeyboardMarkup(row_width=1)
                markup.add(
