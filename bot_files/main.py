...
def build_main_keyboard(user_id):
    ...
    # الصف 1: 🛍 حسابات جاهزة | 👤 حسابي
    markup.add(
        types.InlineKeyboardButton("🛍 حسابات جاهزة", callback_data="btn_ready_tg"),
        types.InlineKeyboardButton("👤 حسابي", callback_data="btn_my_account")
    )
    
    # الصف 2: 📦 طلباتي | 💳 شحن الرصيد
    markup.add(
    ...
    # الصف 3: 🔄 تحويل الرصيد | 🎁 رصيد مجاني
    markup.add(
    ...
    # الصف 5: 🎧 الدعم الفني | ℹ️ التعليمات
    markup.add(
    ...
    # الصف 6: لوحة الإدارة للمشرف فقط
