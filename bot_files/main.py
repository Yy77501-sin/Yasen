...
def build_admin_main_keyboard():
    ...
    markup.add(
        ...
        types.InlineKeyboardButton("✈️ فحص وإعدادات موقع TG", callback_data="admin_check_tg")
    )
    markup.add(
        types.InlineKeyboardButton("⚡ فحص وإعدادات 5SIM", callback_data="admin_settings_fivesim"),
        types.InlineKeyboardButton("🐻 فحص وإعدادات Grizzly", callback_data="admin_settings_grizzly")
    )
    markup.add(
        types.InlineKeyboardButton("💳 فحص وإعدادات Hero SMS", callback_data="admin_settings_hero")
    )
