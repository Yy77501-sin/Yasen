...
class ProviderManager:
    ...
    def create_adapter(self, p_dict: dict) -> BaseProviderAdapter:
        ...
        if atype == "sms_activate":
            return SmsActivateAdapter(p_id, name, url, key, priority, min_bal, atype)
        elif atype == "fivesim":
            return FiveSimAdapter(p_id, name, url, key, priority, min_bal, atype)
        else:
            return StandardRestAdapter(p_id, name, url, key, priority, min_bal, atype)
