...
const FILES_META: Record<string, CodeFileInfo> = {
  providers: {
    name: 'providers.py',
    desc: 'نظام إدارة المزودين المركزي (20 مرحلة): الفحص التلقائي، التبديل الذكي (Failover)، منع الشراء المزدوج، وحماية API Keys.',
    url: '/bot_files/providers.py',
    githubPath: 'bot_files/providers.py'
  },
  database: {
    name: 'database.py',
    desc: 'قاعدة بيانات SQLite الشاملة: جداول المزودين والسجلات، المستخدمين، المنتجات، المخزون، الطلبات، الشحن وسجل التدقيق.',
    url: '/bot_files/database.py',
    githubPath: 'bot_files/database.py'
  },
  main: {
    name: 'main.py',
    desc: 'المحرك الشامل للبوت: متجر الحسابات الجاهزة للتسليم الفوري بالدولار ($)، كود الدخول والضمان، ولوحة الإدارة الكاملة.',
    url: '/bot_files/main.py',
    githubPath: 'bot_files/main.py'
  },
  config: {
    name: 'config.py',
    desc: 'إعدادات المفاتيح والتوكن، الدعم، والعملة الموحدة (USD $).',
