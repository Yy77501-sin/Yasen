                ...
                >
                  ...
                  <div className="space-y-1.5 pt-1">
                    ...
                    <button
                      ...
                      className="w-full bg-[#242f3d] hover:bg-[#2e3b4d] active:scale-98 text-white p-2.5 rounded-xl font-bold text-xs text-center border border-stone-700/60 transition-all flex items-center justify-center gap-1.5 shadow-2xs"
                    >
                      <span className="text-base">📊</span>
                      <span>السيرفرات</span>
                    </button>

                    {/* Row 6: رصيد مجاني | تعليمات واستخدام */}
                    <div className="grid grid-cols-2 gap-1.5">
                      <button
