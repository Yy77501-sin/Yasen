              ...
              {currentScreen === 'main' && (
                ...
                >
                  ...
                  <div className="space-y-1.5 pt-1">
                    ...
                    {/* Row 2: شحن الرصيد | حسابي ومحفظتي */}
                    ...
                    <button
                      ...
                      className="w-full bg-linear-to-r from-sky-900/60 to-indigo-900/60 hover:from-sky-800/80 hover:to-indigo-800/80 active:scale-98 text-sky-200 p-2.5 rounded-xl font-bold text-xs text-center border border-sky-500/40 transition-all flex items-center justify-center gap-1 shadow-2xs"
                    >
                      <span className="text-base">🤖</span>
                      <span>المساعد الذكي (AI)</span>
                    </button>

                    {/* Row 5: الدعم الفني المباشر */}
                    <button
                      onClick={() => setCurrentScreen('support')}
                      className="w-full bg-[#242f3d] hover:bg-[#2e3b4d] active:scale-98 text-white p-2.5 rounded-xl font-bold text-xs text-center border border-stone-700/60 transition-all flex items-center justify-center gap-1 shadow-2xs"
                    >
                      <span className="text-base">💬</span>
