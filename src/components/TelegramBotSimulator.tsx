              ...
              {currentScreen === 'main' && (
                ...
                >
                  ...
                  <div className="space-y-1.5 pt-1">
                    {/* Row 1: شراء حسابات تيليجرام الجاهزة */}
                    <button
                      onClick={() => setCurrentScreen('telegram_ready')}
                      className="w-full bg-linear-to-r from-sky-600 via-indigo-600 to-sky-700 hover:from-sky-500 hover:to-indigo-500 active:scale-98 text-white p-3 rounded-xl font-bold text-xs text-center border border-sky-400/50 transition-all flex items-center justify-center gap-1.5 shadow-md shadow-sky-950/40"
                    >
                      <span className="text-base">✈️</span>
                      <span>شراء حسابات تيليجرام جاهزة (تسليم فوري)</span>
                    </button>

                    {/* Row 2: تفعيل SMS تيليجرام | شحن الرصيد */}
                    <div className="grid grid-cols-2 gap-1.5">
                      <button
                        onClick={() => {
                          const tg = MAIN_APPS_SIM.find(a => a.id === 'telegram') || MAIN_APPS_SIM[0];
                          setSelectedApp(tg);
                    ...
                    {/* Row 3: حسابي ومحفظتي | تحويل الرصيد */}
                    <div className="grid grid-cols-2 gap-1.5">
                      <button
