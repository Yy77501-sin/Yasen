              ...
              {currentScreen === 'main' && (
                ...
                >
                  ...
                  <div className="space-y-1.5 pt-1">
                    ...
                    >
                      <span>بدء طلبية رَشق جديدة 🗃️</span>
                    </button>
                    ...
                    <div className="grid grid-cols-2 gap-1.5">
                      <button
                        ...
                        className="bg-[#242f3d] hover:bg-[#2e3b4d] active:scale-98 text-white p-2.5 rounded-xl font-bold text-xs text-center border border-stone-700/60 transition-all flex items-center justify-center gap-1 shadow-2xs"
                      >
                        <span>خدماتي المفضلة ★</span>
                      </button>
                      <button
                        onClick={() => setCurrentScreen('ai_services')}
                        className="bg-[#242f3d] hover:bg-[#2e3b4d] active:scale-98 text-white p-2.5 rounded-xl font-bold text-xs text-center border border-stone-700/60 transition-all flex items-center justify-center gap-1 shadow-2xs"
                      >
                        <span>اشتراكات برامج AI 🤖</span>
                      </button>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full bg-[#242f3d] hover:bg-[#2e3b4d] active:scale-98 text-white p-2.5 rounded-xl font-bold text-xs text-center border border-stone-700/60 transition-all flex items-center justify-center gap-1 shadow-2xs"
                    >
                      <span>ارقام حسابات تليجرام ✈️</span>
                    </button>
                    ...
                    <button
                      ...
                      className="w-full bg-[#242f3d] hover:bg-[#2e3b4d] active:scale-98 text-white p-2.5 rounded-xl font-bold text-xs text-center border border-stone-700/60 transition-all flex items-center justify-center gap-1 shadow-2xs"
                    >
                      <span>المتجر الإلكتروني (بيع وشراء) ⚙️</span>
                    </button>
