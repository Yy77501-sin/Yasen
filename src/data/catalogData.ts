...
ضمان وقت البدء فوري الجودة حسابات عالية الجودة السرعة: حتى 100 ألف متابع يوميا معدل السقوط لا يوجد إعادة التعبئة: نعم التعويض نعم زر الإلغاء : مُفعّل. الرابط رابط قناة أو مجموعة تيليجرام . ملاحظات قد تختلف سرعة التنفيذ عند ارتفاع الضغط على الخدمة. لا تطلب الخدمة مرة أخرى على نفس الرابط حتى يكتمل الطلب الحالي عند وجود أي مشكلة، تواصل مع الدعم.`
  ...
  },
  {
    ...
    section: 'رشق تيليجرام',
    title: 'تفاعلات تيليجرام إيجابية (👍 ❤️ 🔥) | فوري',
    rawUnitPrice: 0.00015,
    rawPer1000: 0.15,
    minQty: 20,
    maxQty: 100000,
    quality: 'تفاعلات مشكلة إيجابية',
    speed: 'فوري خلال لحظات',
    guarantee: 'ثابت بدون نقص',
    refill: 'نعم',
    compensation: 'نعم',
    cancelBtn: 'مُفعّل',
    linkType: 'رابط منشور القناة',
    desc: 'رفع تفاعل المنشورات بالتفاعل الإيجابي المناسب.'
  },
  {
    id: 'ig_king_likes',
    section: 'رشق إنستغرام',
    title: 'لايكات إنستغرام فائقة السرعة | جودة ممتازة',
    rawUnitPrice: 0.00030,
    rawPer1000: 0.30,
    minQty: 50,
    maxQty: 200000,
    quality: 'حسابات بصور حقيقية',
    speed: '10 آلاف في الساعة',
    guarantee: 'مدى الحياة',
    refill: 'نعم',
    compensation: 'نعم',
    cancelBtn: 'مُفعّل',
    linkType: 'رابط منشور أو ريلز إنستغرام',
    desc: 'لايكات فورية لزيادة وصول المنشور للإكسبلور.'
  },
  {
    id: 'pubg_60',
    section: 'شحن ألعاب',
    title: 'شدات ببجي PUBG (60 UC) | شحن فوري ID',
    rawUnitPrice: 0.85,
    rawPer1000: 850.0,
    minQty: 1,
    maxQty: 10,
    quality: 'شحن رسمي ID فوري',
    speed: 'خلال 1-5 دقائق',
    guarantee: 'شحن رسمي معتمد 100%',
    refill: 'غير منطبق',
    compensation: 'نعم',
    cancelBtn: 'مُفعّل',
    linkType: 'أدخل الآيدي (Player ID) واسمك داخل اللعبة',
    desc: 'شحن مباشر ورسمي لشدات ببجي موبايل عبر الآيدي.'
  },
  {
    id: 'pubg_325',
    section: 'شحن ألعاب',
    ...
    compensation: 'نعم',
    cancelBtn: 'مُفعّل',
    linkType: 'الآيدي (Player ID) داخل لعبة ببجي',
    desc: 'شحن كافي لفتح الرويال باس والمواسم فوراً.'
  }
];
